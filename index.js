...
bot.start(ctx => {
  ...
  ctx.reply(`Вітаю! Я бот, що вміє видобувати відео з TikTok посилань та пересилати їх іншим людям. Перешли це повідомлення до чату, куди я надсилатиму відео. Пам'ятай, я маю бути адміністратором аби отримувати всі повідомлення.`);
});
bot.on('text', ctx => {
